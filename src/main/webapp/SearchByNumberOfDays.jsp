...
<body>
	<div class="topnav">
		<a href="JobList.jsp">Home</a> <a href="AddJob.jsp">Add Job</a> <a
			href="AdobeJobs.jsp">Adobe Jobs</a> <a href="">Search By</a>
    ...
    const keyword = urlParams.get('numberOfDays');
    rawFile.open("GET", "jobs.xml", false);
    rawFile.send();
    let xml = new DOMParser().parseFromString(rawFile.responseText,"text/xml");
    const d = new Date();
    let path = "./jobs/node()[(add_date/day + 30 * add_date/month + 365 * add_date/year) >= " + ((d.getDate() + 30 * (d.getMonth() + 1) + 365 * d.getFullYear()) - Number(keyword)) + "]";
